// Built using the following as reference:
//   Docs: https://ai.google.dev/gemini-api/docs/music-generation#javascript
//   Working Example: https://aistudio.google.com/app/apps/bundled/promptdj-midi?utm_medium=referral&utm_campaign=gdm&utm_content=&showTreeView=true&showCode=true&showPreview=true

import { GoogleGenAI, LiveMusicServerMessage, LiveMusicSession, type AudioChunk, type LiveMusicFilteredPrompt } from '@google/genai'
...
const model = 'lyria-realtime-exp' as const
